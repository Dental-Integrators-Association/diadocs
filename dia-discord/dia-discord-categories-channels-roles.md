...
## welcome
### rules
The #rules channel explains all rules & guidelines to participate in The DIA's Discord server. They are the production rules. Whenever the [DIA Discord Rules & Guidelines](https://github.com/Dental-Integrators-Association/diadocs/blob/main/dia-discord/dia-discord-rules-guidelines.md) document is updated, this channel's pinned messages are updated with the latest rules & guidelines. This channel is also the only channel the role @everyone can see. This is also the channel the promoted invite link is linked too.
...
### member-verify
This is where users are verified as part of teams that are paying companies within the DIA organization. Please see [MOD SOP: Verifying Member Companies](https://github.com/Dental-Integrators-Association/diadocs/blob/main/dia-discord/dia-discord-mod-sop-verifying-member-companies.md) for how we verify companies.
...
## @dia-leadership
This role is for anyone in the DIA that holds a leadership position. Not all leaders in the DIA are responislbe for moderating, administrating, or developing DIA sub-communties directly. These are assigned by DIA Leadership and their commitees. We needed a role to recognize DIA Leadership & setting permissions for certain rooms without infering DIA Leadership is directly responsible for Discord or other communities.
